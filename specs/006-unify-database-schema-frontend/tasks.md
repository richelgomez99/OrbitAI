# Tasks: Unify database schema and frontend type system to eliminate type mismatches. The Prisma database sch

**Input**: Design documents from `specs/006-unify-database-schema-frontend/`
