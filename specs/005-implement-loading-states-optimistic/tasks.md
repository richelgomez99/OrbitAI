# Tasks: Implement loading states and optimistic UI updates for all async operations. Every button, form subm

**Input**: Design documents from `specs/005-implement-loading-states-optimistic/`
